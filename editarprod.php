    ...
    <div>
        ...
        <div>
            ...
            <div class="degrade">
                    ...
                    <div class="container py-5">
                        <div class="row g-5 align-items-center">
                            <div class="col-lg-13" >
                                ...
                                <p class="p-welcome text-center">Edite aqui os seus produtos
                                </p>
                ...
                <!-- Header End -->
                <div class="container-fluid back-flower" style="padding-bottom: 5%;">
                    <div class="col-lg-13">
                        <div class="container container-form py-5">
                            <form style="width: 75%;" id="formEditProd" name="formEditProd" method="post" action="controller/controller.php?funcao=updateProd&id_prod=<?php echo $produto[0]['id_prod']; ?>" enctype="multipart/form-data">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control form-control-lg" required id="txtTitle" name="txtTitle"
                                        placeholder="Título" value="<?php echo $produto[0]['title']; ?>">
                                </div>
                                <div class="form-group" style="margin-top: 35px;">
                                    ...
                                    <textarea class="form-control form-control-lg" required id="txtDescr" name="txtDescr"
                                        placeholder="Descrição" rows="5"><?php echo $produto[0]['descr']; ?></textarea>
                                </div>
                                <div class="form-group" style="margin-top: 35px;">
                                    ...
                                    <input type="number" class="form-control form-control-lg" required id="txtValor" name="txtValor"
                                        placeholder="Preço" value="<?php echo $produto[0]['valor']; ?>">
                                </div>
                                <div class="form-group" style="margin-top: 35px;">
                                    ...
                                    <input type="number" class="form-control form-control-lg" required id="txtDt_lanc" name="txtDt_lanc"
                                        placeholder="Ano da Publicação" value="<?php echo $produto[0]['dt_lanc']; ?>">
                                </div>
                                <div class="form-group" style="margin-top: 35px;">
                                    ...
                                    <input type="number" class="form-control form-control-lg" required id="txtNum_pags" name="txtNum_pags"
                                        placeholder="N° de Páginas" value="<?php echo $produto[0]['num_pag']; ?>">
                                </div>
                                <div class="form-group" style="margin-top: 35px;">
                                    ...
                                    <input type="text" class="form-control form-control-lg" required id="txtPublico" name="txtPublico"
                                        placeholder="Público-alvo" value="<?php echo $produto[0]['publico']; ?>">
                                </div>
                                <div class="form-group" style="margin-top: 35px;">
                                    ...
                                    <input type="text" class="form-control form-control-lg" required id="txtLink" name="txtLink"
                                        placeholder="Link para compra" value="<?php echo $produto[0]['link']; ?>">
                                </div>
                                <div class="form-group" style="margin-top: 35px;">
                                    <label class="p-welcome">Selecione uma nova foto</label>
                                    <input type="file" accept="image/*" class="form-control form-control-lg" id="pic" name="pic"
                                        class="form-control">
                                </div>
